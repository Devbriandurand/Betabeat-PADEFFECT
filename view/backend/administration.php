...
<?php $title = 'titleAdministration' ?>
    ...
    <h1 id="titleAdministration">ADMINISTRATION</h1>
    ...
    <table id="adminTabHeader">
        ...
        <?php foreach ($chapters as $chapter) : ?>
            <tr>
                ...
                <td class="tdAdminTitle" id="tdAdmin"><?= htmlspecialchars($chapter['title']) ?></td>
                <td id="tdAdmin"><?= htmlspecialchars($chapter['content']) ?></td>
